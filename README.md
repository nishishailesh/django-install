...
# startapp
1. if your project directory is dj, in which manage.py is there run following command (in this example for authantication app based on auth app)
2. ``python3 manage.py startapp authetication``
